...
export default function PersonalAreaPurchase() {
  return (
    <>
      ...
      <form class="main-section">
        <div class="container">
          ...
          <div class="main-inner">
            <ul class="tabs">
              <li>
                <a href="personal_area_New.html">Новые</a>
              </li>
              <li class="current">
                <a href="personal_area_Purchase.html">На закупке</a>
              </li>
              <li>
                <a href="#">Выкуплен</a>
              </li>
        ...
        <div class="container">
          ...
          <form class="main-inner">
            <div class="button-wrapper purchase">
              <button class="button no-icon">Закуплено</button>
              <button class="button no-icon">Отменить закупку</button>
            </div>
            <div class="push40 hidden-xss"></div>
            <div class="push20 visible-xss"></div>
            <div class="form-group">
              <label class="label" for="priceCNY">
            ...
            <div class="form-group">
              <label class="label" for="cursCNY">
                Фактический курс обмена CNY
              </label>
              <input
                name="cursCNY"
                type="text"
            ...
            <div class="form-group">
              ...
              <input name="CNY" type="text" class="form-control" id="CNY" />
            </div>
            <div class="form-group">
              <label class="label" for="POIZON">
            ...
            <div class="push10 visible-xss"></div>
            <div class="label">Изображения чеков закупки</div>
            <div class="push10 hidden-xss"></div>
            <div class="img-wrapper-purchase" id="purchase-check"></div>
            <div class="form-group check">
              <div class="file-input fileInput" id="fileInputCheck">
                <input
                  type="file"
                  id="fileInput"
            ...
            <div class="push40 hidden-xss"></div>
            <div class="push20 visible-xss"></div>
            <div class="label">Изображение со склада</div>
            <div class="push10 hidden-xss"></div>
            <div class="img-wrapper-purchase" id="purchase-depot"></div>
            <div class="form-group check">
              <div class="file-input fileInput" id="fileInputDepot">
                <input
                  type="file"
                  id="fileInput"
                  accept="image/jpeg,image/png,image/gif"
